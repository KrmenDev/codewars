...
//array of numbers, can be positive or negative, never empty
//return the index of the num that the sum to its right and left are the same
//[1,2,3,4,3,2,1] => 3
//[8,8] =>  -1
//[8,0] =>  0
//[-1,1,0,-1,1,0,-1,1,0,0] => 2
//grab the left and right size of arr
...
function findEvenIndex(arr) {
    ...
    for(let i = 0; i < arr.length; i++){
        //we subtract current element to the right side sum
        right -= arr[i]
        ...
        //we add current element to the left sum for next iteration
        left += arr[i]
    }
