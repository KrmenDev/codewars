...
//array of numbers, always positive, can repeat
//return how many times smallest nums need to be add up to be greater than value
//[8, 9, 10, 4, 2], 23 => 3
//[4, 6, 3], 2 => 0
//[4, 6, 3], 7 => 1
//sort arr low to high
//loop arr and add first two and compare to value
//return count
...
function minimumSteps(numbers, value){
  ...
  for(let i =0; i <= arr.length; i++){
    ...
    if(arr.slice(0,i+1).reduce((acc,c)=> acc+c, 0) >= value){
        return i
    }
  }
  return i
