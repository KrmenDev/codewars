...
//array of always positive integers representing the index of the next element to move in the chain, can be empty, include zero
//return true if index appears more than once
//[1,2,3,4,2] => true
//[0] => true
//[1,0] => true
//[2,0,1,5] => true
...
//[3,2,1,6] => false
//[] => false
//keep track of indexes already visited
//if current index is in visited return true else false
...
const hasLoop = indices => {
  for (let i = 0, visited = []; i in indices; i = indices[i]) {
