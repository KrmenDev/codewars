...
//list arr language and githubAdmin, always same format, never empty
// return the devs on list that code in lang 
//loop arr and return all devs tat are admins and have the lang
